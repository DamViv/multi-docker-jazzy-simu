...
docker build --build-arg HTTP_PROXY="http://proxy.isae.fr:3128" -t ros-jazzy-gazebo ./gz_simulator 
docker build --build-arg HTTP_PROXY="http://proxy.isae.fr:3128" -t ros-jazzy-nav ./ros_jazzy_nav
...
## To launch another terminal :
# docker exec -it ros-jazzy-nav bash
